...
var Config = function () {
   ...
   * @type {float}
   */
  this.breakPointMobile = 722;

  /**
   * Get current mode
   * @type {boolean}
   */
  this.isDevMode = window.location.origin == "http://dev.zocdoc.sdny.in" ? false : true;

  /**
   * current folder App path
   */
  this.folderPath = window.location.origin + "/wp-content/themes/zocdoc-careers/";
