                        ...
                        <a href="<?php echo $post->guid; ?>">
                            ...
                            <?php if (!empty(get_post_thumbnail_id($post->ID))): ?>
                                <header class="post-header"
                                        style="background: url(<?php echo wp_get_attachment_url(get_post_thumbnail_id($post->ID)) ?>) 50% 50% / cover no-repeat;"></header>
                            <?php else: ?>
                            ...
                            <div class="text-wrapper">
                                ...
                                <div class="info">
                                    ...
                                    - <?php $duration = get_field('read_duration');  echo $duration; ?> min read</span>
                                </div>
                            </div>
