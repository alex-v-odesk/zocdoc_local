<?php
    ...
    $key = (!$url[count($url) - 1]) ? $url[count($url) - 2] : $url[count($url) - 1];
    switch($key) {
        case 'about-zocdoc': 
            header("HTTP/1.1 301 Moved Permanently"); header("location:https://support.zocdoc.com/patients/s/topic/0TO32000000Q3OPGA0/about-zocdoc?tabset-e6060=2"); exit();
        case 'my-account': 
            header("HTTP/1.1 301 Moved Permanently"); header("location:https://support.zocdoc.com/patients/s/topic/0TO32000000Q3OSGA0/my-account?tabset-e6060=2"); exit();
        case 'reviews': 
            header("HTTP/1.1 301 Moved Permanently"); header("location:https://support.zocdoc.com/patients/s/topic/0TO32000000Q3OTGA0/reviews?tabset-e6060=2"); exit();
        case 'making-an-appointment': 
            header("HTTP/1.1 301 Moved Permanently"); header("location:https://support.zocdoc.com/patients/s/topic/0TO32000000Q3ORGA0/making-appointments?tabset-e6060=2"); exit();
    }
?><?php
/**
*
