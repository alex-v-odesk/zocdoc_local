...
function zocdoc_scripts() {
	...
	if ($detect->isMobile()) {
		wp_enqueue_style('zocdoc-mobile', get_template_directory_uri() . '/styles/output/mobile/mobile-style.css');
	} else {
  ...
  if ( is_page_template( 'patient-powered-search.php' ) ) {
	  wp_enqueue_style('patient-powered-search-style', get_template_directory_uri() . '/styles/output/desktop/styles/patient-powered-search.css');
		wp_enqueue_script('patient-powered-search-createjs', 'https://code.createjs.com/createjs-2015.11.26.min.js');
    // greensock
    wp_enqueue_script('patient-powered-search-greensock', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js');

		// adobe animate - assets script
		wp_enqueue_script('patient-powered-search-core', get_template_directory_uri() . '/js/patient-powered-search.js');
		// adobe animate - init scripts
		wp_enqueue_script('patient-powered-search-canvas', get_template_directory_uri() . '/js/patient-powered-search-canvas.js');
  }
