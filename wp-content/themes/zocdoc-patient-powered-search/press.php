...
<?php function BLOGS() {
	global $post;
?>
<?php /*zocdoc blog posts*/ ?>
<div id="blogs" class="link-el">
<div class="header-text max-width">
	<a  href="http://blog.zocdoc.com/" class="sg-header4 margin">Zocdoc blog</a>
</div>
<div class="all-posts max-width">
<div class="margin">
<?php
$rss = new DOMDocument();
$rss->load('http://blog.zocdoc.com/feed/');
$feed = array();
...
for($x=0;$x<$limit;$x++) {
	...
	?>
	<div class="post">
		<p class="sg-title date"><?php echo $date ?></p>
		<p class="sg-title title"><?php echo $title ?></p>
		<p class="sg-title more">
...
<div class="see-all blog-more max-width">
	<a class="margin" href="http://blog.zocdoc.com/">Visit blog</a>
</div>
<div class="press-hr"></div>

<?php /*doctor blog posts*/ ?>
<div class="header-text max-width">
	<a href="http://www.thedoctorblog.com/" class="sg-header4 margin">Doctor blog</a>
</div>
...
<?php
$rss = new DOMDocument();
$rss->load('http://www.thedoctorblog.com/feed/');
$feed = array();
foreach ($rss->getElementsByTagName('item') as $node) {
	$item = array (
		'title' => $node->getElementsByTagName('title')->item(0)->nodeValue,
...
<div class="see-all blog-more max-width last">
	<a class="margin" href="http://www.thedoctorblog.com/">Visit blog</a>
</div>
</div>
