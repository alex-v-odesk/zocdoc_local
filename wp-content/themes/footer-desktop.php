...
<?php
    if(!isset($footer_text)){
        $footer_text='Need help booking online? <a class="phone-number" data-test="layout-phonenumber" href="tel:(855) 962-3621">(855) 962-3621</a>';
    }
    if(!isset($footer_email)){
        $footer_email="Service@Zocdoc.com";
    }
?>
...
<div class="sg-row sg-header6 contact-info sg-yellow-bg">
    ...
    <table class="sg-small-12 sg-columns help-container">
        <tbody><tr><td><?php echo $footer_text?></td>
    </tr></tbody></table>
...
<div class="sg-row links-and-text links sg-navy-bg layout-footer-content">
        <div class="sg-small-3 sg-columns sg-small-offset-1">
            ...
            <ul>
                    ...
                    <li><a href="https://support.zocdoc.com/patients">FAQ</a></li>
        ...
        <ul>
            ...
            <li>
                <a href="https://plus.google.com/104979133689507882900/" rel="publisher nofollow">
                    <span class="ss-icon google">Google+</span>
                    <span>Google+</span>
                </a>
            </li>
            <li>
                <a href="http://www.linkedin.com/company/167902" rel="nofollow">
                    <span class="ss-icon linkedin">LinkedIn</span>
                    <span>LinkedIn</span>
                </a>
            </li>
<!--
            <li>
                <a href="https://www.youtube.com/user/ZocDocVideo" rel="nofollow">
                    <span class="ss-icon youtube">YouTube</span>
                    <span>YouTube</span>
                </a>
            </li>
-->
