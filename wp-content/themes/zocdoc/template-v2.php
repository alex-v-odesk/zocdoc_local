...
<?php function IMAGE_W_FORM() {
  // global $post;
?>
<div class="banner template text-w-form link-el" style="background-image:url(<?php the_sub_field('image_image')?>); background-position-x: 6vw; height: auto;" id="<?php
$title = get_sub_field('menu_title');
echo str_replace(' ', '_', $title);
 ?>">
  <div class="max-width">
 ...
 ?>">
  <div class="max-width">
    <div class="margin">
      ...
      <?php
      if (get_sub_field('button_text'))
        echo "<a class='sg-btn sg-btn-med' href='".get_sub_field('button_link')."'>".get_sub_field('button_text')."</a>";
      ?>
      </div>
      <div class="bottom">
...
<?php
  $noCTA = true;
  include( get_template_directory() . '/footer-v2.php');
?>
</main>
