...
<?php
    if(!isset($footer_text)){
        $footer_text='Want to speak with an expert? <a class="phone-number" data-test="layout-phonenumber" href="tel:(877) 454-4295">(877) 454-4295</a>';
    }
    if(!isset($footer_email)){
        $footer_email="Info-SponsoredResults@Zocdoc.com";
    }
?>
